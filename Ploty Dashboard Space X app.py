...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        return fig
            ...
            site_success_count.columns = ['class', 'count']
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        x='Payload Mass (kg)',
        y='class',
        color='Booster Version Category',  # opcional, para colorear según otra categoría
        title='Payload Mass (kg)',
        labels={'class': 'Launch Success', 'Payload Mass (kg)': 'Payload (kg)'}
)
        return fig
    else:
            filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
